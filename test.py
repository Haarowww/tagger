...
if __name__ == '__main__':
    ...
    print("Training on training1.txt, running tests on test1.txt. "
          "Output --> output1.txt")
    os.system("python3 tagger.py --trainingfiles training1.txt --testfile test1.txt --outputfile output1.txt")
    ...
    with open("output1.txt", "r") as output_file, \
        ...
        results_file.write(f"Total matches percentage: {total_matches / len(output)}.\n")